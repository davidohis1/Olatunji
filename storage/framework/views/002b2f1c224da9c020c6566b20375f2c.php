            ...
            <div class="row" id="row">
                ...
                <div class="col-lg-3 col-sm-6 d-flex mx-2 flex-column product-item my-3" id="product">
                    <div class="product pt-3" > 
                        <a onclick="view(<?php echo e($room->id); ?>)">
                    ...
                    <div class="text-center pt-0">
						...
						<img src="/images/location.png" width="13px" alt=""> <span class="span5"><?php echo e($room-> place); ?></span>
					</div>
                        <h1 class="title pt-0 pb-1 fw-bold" style="font-size:20px;"><?php echo e($room-> name); ?></h1>
                        <h2 class="title2 pt-1 pb-1 " style="font-size:15px;"><?php echo e($room-> location); ?></h2>
                        <h3 class="price fw-bold" style="font-size:20px;">#<?php echo e($room-> price); ?>,000</h3>
                    </div>
                </div>
...
</html><?php /**PATH C:\Users\HP\Desktop\example-app\htdocs\laravel1\resources\views/index.blade.php ENDPATH**/ ?>