...
<body>
    <div class="justify-content-center" style="height:100%;display:flex;">
        ...
        <h2>Filter Products</h2>
            <ul>
                <form action="<?php echo e(route('last')); ?>" method="post">
                    <?php echo csrf_field(); ?>
        ...
        <div class="content" style="height:100%;width:100%;">
            <nav class="" style="flex">
                <div class="row">
                <form action="<?php echo e(route('last')); ?>" class="col-md-12">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                ...
                <div class="col-lg-3 col-sm-6 d-flex mx-2 flex-column product-item my-3" id="product">
                    ...
                    <div class="text-center pt-0 form">
                        ...
                        <h2 class="title pt-0 pb-1" style="color:orange;"><?php echo e($sites-> quantity); ?> left</h2>
...
<?php /**PATH C:\Users\HP\Desktop\example-app\htdocs\Business Management Site\resources\views/lastproducts.blade.php ENDPATH**/ ?>